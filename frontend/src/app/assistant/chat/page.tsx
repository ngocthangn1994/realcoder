...
export default function Page(){return <AppShell title="Assistant Chat" links={links}><div className="rounded-xl border bg-white p-4">Assistant chat workspace for client support workflow.</div></AppShell>}
