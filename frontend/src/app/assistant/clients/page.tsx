...
export default function Page(){return <AppShell title="Assistant Clients" links={links}><div className="rounded-xl border bg-white p-4">Assistant clients workspace for client support workflow.</div></AppShell>}
