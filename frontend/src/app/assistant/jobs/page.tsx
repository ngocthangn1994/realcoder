...
export default function Page(){return <AppShell title="Assistant Jobs" links={links}><div className="rounded-xl border bg-white p-4">Assistant jobs workspace for client support workflow.</div></AppShell>}
